...
<tr><td> <em>Generated: </em> 6/8/2023 4:05:58 PM</td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fam3525%2F2023-06-08T19.36.34Primary-page.png.webp?alt=media&token=179a057c-f41d-4d5a-a470-ba359fb475ed"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing Primary Page<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fam3525%2F2023-06-08T19.37.10Login-Page.png.webp?alt=media&token=76a4348f-dee3-4520-97e8-c853c6819a1a"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing Login Page<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fam3525%2F2023-06-08T19.37.44Register-Page.png.webp?alt=media&token=106d5bea-e556-4469-a105-d4914f132214"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing Register Page<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fam3525%2F2023-06-08T19.38.10Profile-Page.png.webp?alt=media&token=051f8871-c851-4480-9867-04312b39a328"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing Profile Page<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fam3525%2F2023-06-08T19.38.43Logout-Page.png.webp?alt=media&token=58502db1-0bfa-49f8-9d92-03ae084e2403"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing Logout Page<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>To make the navigation horizontal, I used the &#39;display: inline&#39; feature to make<br>all the &lt;li&gt; tags from the nav to be inline with each other<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>I set &#39;list-style-type&#39; to &#39;none&#39; on the &lt;li&gt; tags to remove any list<br>item markers from the nav<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I used &#39;background-color&#39; on the &lt;nav&gt; element and gave it a gray color<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I used &#39;a:hover&#39; on the &lt;nav&gt; tag to make any link inside that<br>nav tag change color when it is hovered over<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I used the &#39;::marker&#39; feature to select the marker of the list items<br>and I changed the content to be a checkmark&nbsp;<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I selected all &lt;h1&gt; and &lt;a&gt; elements and used &#39;text-transform:capitalize&#39; to make the<br>first characters uppercased<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I&nbsp; used &#39;a:active&#39; and changed the color of all &lt;a&gt; tags inside the<br>nav to blue whenever they are clicked on<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>The styling of the navigation list was specified with the &lt;nav&gt; tag, which<br>was not present for the challenge list. This meant that the styling for<br>the two lists did not affect each other<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I created a variable &#39;navLinks&#39; to hold the array of all the anchor<br>tags inside the &lt;nav&gt; element, which were obtained using querySelectorAll. I then used<br>a for loop to iterate through the array of anchor tags and added<br>an event listener with a function that executed when an anchor tag was<br>clicked. This function created a new variable to hold the text of the<br>anchor tag using &#39;event.target.innerText&#39;. The variable was then passed throught the updateCurrentPage function<br>that updated the &lt;h1&gt; tag with the new word that it took in<br>as an argument.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I created a variable &#39;navLinks&#39; to hold the array of all the anchor<br>tags inside the &lt;nav&gt; element, which were obtained using querySelectorAll. I then used<br>a for loop to iterate through the array of anchor tags and added<br>an event listener with a function that executed when an anchor tag was<br>clicked. This function created a new variable to hold the text of the<br>anchor tag using &#39;event.target.innerText&#39;. The variable was then passed throught the updateCurrentPage function<br>that updated the &lt;title&gt; tag with the new word that it took in<br>as an argument.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Agraw-Mindaye/IT202-451/pull/7">https://github.com/Agraw-Mindaye/IT202-451/pull/7</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add a link to your solution html file from prod (again you can assume the url at this point)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://am3525-prod.herokuapp.com/M3/challengle/html">https://am3525-prod.herokuapp.com/M3/challengle/html</a> </td></tr>
</table></td></tr>
